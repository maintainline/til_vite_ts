...
### 2. ts 마이그레이션 (확장자 변경후 import 다시 하기!)

- /src/types 폴더 생성
- /src/types/TodoType.ts 파일 생성(확장자 조심!)
...
- App.tsx 로 변경 (main.tsx 다시 import 불러와야함.)
...
- TodoWrite.tsx 로 변경 (App.tsx 다시 import 불러와야함.)
...
- TodoList.tsx 로 변경 (App.tsx 다시 import 불러와야함.)
...
- TodoItem.tsx 로 변경 (App.tsx, TodoList.tsx 다시 import 불러와야함.)
