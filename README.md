...
function Calendar() {
  const [events, setEvents] = useState<EventInput[]>([
    { id: '1', title: '오늘은 월요일', start: '2025-09-02', allDay: true },
    { id: '2', title: '오늘은 월요일', start: '2025-09-02', allDay: true },
    { id: '3', title: '오늘은 월요일', start: '2025-09-02', allDay: true },
    { id: '4', title: '오늘은 월요일', start: '2025-09-02', allDay: true },
    { id: '8', title: '오늘은 월요일', start: '2025-09-02', allDay: true },
    { id: '9', title: '오늘은 월요일', start: '2025-09-02', allDay: true },
    { id: '5', title: '오늘은 월요일', start: '2025-09-02', allDay: true },
...
const [events, setEvents] = useState<EventInput[]>([
  ...
  { id: '6', title: '우리반 운동회2', start: '2025-09-03', allDay: true },
  { id: '7', title: '과학 실험', start: '2025-09-05T10:00:00', end: '2025-09-05T11:00:00' },
]);
```
...
<FullCalendar
  ...
   eventColor="#b9acff" //  기본 일정 배경색
   eventTextColor="#ffffff" // 기본 일정 텍스트
   eventBorderColor="#5b73ff" // 기본 일정 테두리 색상
 />
```

- 클래스로 일정 색상 통일하기 : (카테고리 별로 처리하기)
