...
- /src/components/todos/TodoWriteBox.tsx
  ...
  return (
    <div className="card">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Link to={'/todos/write'} className="btn btn-primary" style={{ color: 'white' }}>
          작성하기
        </Link>
      </div>
    </div>
...
- App.tsx 업데이트
- `edit 과 detail 은 id 를 param 으로 전달`함.
